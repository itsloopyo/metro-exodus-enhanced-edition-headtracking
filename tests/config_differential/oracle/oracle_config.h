...
// The reader of the newest published build, the rolling dev pre-release at a71df8b, for the
// differential test only. Copied from src/config.h at that commit. The only edits: this
// comment, the namespace is metroex::oracle, and the ADS helpers come from oracle_ads.h.
