...
// What the dev build's reader called for its ADS keys: cameraunlock-core 26b4f17's
// cpp/include/cameraunlock/ads/ads_mode.h under this namespace, then the using-declarations of
// a71df8b's src/ads.h that its config.h and config.cpp use. Core no longer has the header.

#include <cctype>
#include <cstring>
#include <initializer_list>

namespace metroex::oracle::ads {
