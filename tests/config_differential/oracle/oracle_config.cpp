...
// differential test only. Copied from src/config.cpp at that commit. The only edits: this
// comment, the namespace is metroex::oracle, and the header is oracle_config.h.
